...
HUFS MAP 백엔드는 Appwrite를 기반으로 사용자 인증, 사용자 정보 관리, 건물 즐겨찾기, 회원 탈퇴 Function을 관리한다.

### 주요 기능

- Appwrite Authentication 기반 로그인
- 학교 이메일 인증
- users 컬렉션 사용자 정보 저장
- 건물 즐겨찾기 favoriteBuildings 관리
- 회원 탈퇴 delete-user Function
- 마이페이지 사용자 정보 조회